 ...
 * {@link RecD.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link RecD#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RecD extends Fragment {
     ...
     * @return A new instance of fragment RecD.
     */
    // TODO: Rename and change types and number of parameters
    public static RecD newInstance(String param1, String param2) {
        RecD fragment = new RecD();
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof RecD.OnFragmentInteractionListener) {
            mListener = (RecD.OnFragmentInteractionListener) context;
        } else {
...
//        }
    ...
    public void populateListFood(){
        ...
        try{
            listCursor = db.select("food", fields, "food_energy_calculated", "775","food_energy_calculated","900", "food_name", "ASC");
        }
